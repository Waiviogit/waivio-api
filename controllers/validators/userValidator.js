  ...
  user_metadata: Joi.object().keys({
    ...
    settings: Joi.object().keys({
      ...
      userNotifications: Joi.object().keys({
        account_witness_vote: Joi.boolean().default(true),
        activateCampaign: Joi.boolean().default(true),
        changePassword: Joi.boolean().default(true),
        change_recovery_account: Joi.boolean().default(true),
        comment: Joi.boolean().default(true),
        custom_json: Joi.boolean().default(true),
        fillOrder: Joi.boolean().default(true),
        rejectUpdate: Joi.boolean().default(true),
        restaurantStatus: Joi.boolean().default(true),
        suspendedStatus: Joi.boolean().default(true),
        transfer: Joi.boolean().default(true),
        transfer_from_savings: Joi.boolean().default(true),
        transfer_to_vesting: Joi.boolean().default(true),
        withdraw_route: Joi.boolean().default(true),
        withdraw_vesting: Joi.boolean().default(true),
      }),
    }).default({
