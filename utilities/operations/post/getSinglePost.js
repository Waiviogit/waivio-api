 ...
 * Return merged data of "steem" post/comment with post/comment from Mongo DB, merging augment keys and likes from "active_votes"
 * Post/comment wrote by guest user through proxy-bot can be returned with "guest" user as author and with "proxy-bot" as author,
...
const getComment = async ( { author, permlink } ) => {
    ...
    return await mergeCommentData( result[ 0 ] );
};
