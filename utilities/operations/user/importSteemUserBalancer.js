 ...
 * @returns {Promise<{error: (Object)}|{result: {ok: boolean}}>} result {ok:true} on success or error
 */
...
/**
 * Return true if count of currently importing users are valid(zero or less than MAX_IMPORTING_USERS)
