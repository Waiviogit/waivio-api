...
const topWobjUsersClient = redis.createClient(process.env.REDISCLOUD_URL);
...
topWobjUsersClient.select(config.redis.topWobjUsers);

module.exports = { wobjRefsClient, importUserClient, mainFeedsCacheClient, topWobjUsersClient };
